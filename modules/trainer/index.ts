...
export async function getTopTrainers() {
  try {
    ...
    console.error("[trainer] getTopTrainers failed", error);
    return [];
  }
}
...
export async function getAllTrainers() {
  try {
    ...
    console.error("[trainer] getAllTrainers failed", error);
    return [];
  }
}
...
export async function getTrainerProfile(trainerId: string) {
  try {
    ...
    console.error("[trainer] getTrainerProfile failed", error);
    return null;
  }
}
